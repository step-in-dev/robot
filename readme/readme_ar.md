...
**الموقع:** [⁦robot.stepindev.com⁩](https://robot.stepindev.com) – فهرس المهام ومرجع الأوامر والمقالات.
...
3. احفظ ملف الحل بجانب وحدة ⁦robot⁩. استخدم ملف **⁦sample_solution.py⁩** من الأرشيف كنقطة بداية.
4. لتشغيل تمرين مختلف، غيِّر النص المُمرَّر إلى **⁦task()⁩** (انظر قسم **المهام المتاحة لـ ⁦task()⁩** أعلاه).

المتطلبات: **⁦Python 3.7+⁩** مع المكتبة القياسية (تستخدم الواجهة ⁦tkinter⁩، المُضمَّنة في معظم تثبيتات ⁦Python⁩ على أنظمة سطح المكتب).
