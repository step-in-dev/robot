...
Цей проєкт є навчальним симулятором **Робота** для засвоєння основ програмування та алгоритмізації. Учні пишуть короткі програми мовою Python, які керують Роботом на клітчастому полі: переміщують його, фарбують клітинки, зчитують стан середовища й розв’язують невеликі завдання з наочною зворотною зв’язкою у вікні застосунку.
...
Вимоги: **Python 3** зі стандартною бібліотекою (інтерфейс використовує `tkinter`, який входить до більшості встановлень Python на настільних системах).
