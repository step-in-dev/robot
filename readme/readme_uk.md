...
**Сайт:** [robot.stepindev.com](https://robot.stepindev.com) — каталог завдань, довідник команд і статті.
...
3. Збережіть файл із розв’язанням поруч із модулем `robot`. Як відправну точку використовуйте файл **`sample_solution.py`** з архіву.
