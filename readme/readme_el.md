...
3. Αποθηκεύστε το αρχείο λύσης σας δίπλα στο πακέτο `robot`. Χρησιμοποιήστε το **`sample_solution.py`** από το αρχείο ως σημείο εκκίνησης.
...
Απαιτήσεις: **Python 3** με την πρότυπη βιβλιοθήκη (η διεπαφή χρήστη χρησιμοποιεί `tkinter`, το οποίο περιλαμβάνεται στις περισσότερες εγκαταστάσεις Python σε συστήματα επιφάνειας εργασίας).
