...
**ওয়েবসাইট:** [robot.stepindev.com](https://robot.stepindev.com) — টাস্ক ক্যাটালগ, কমান্ড রেফারেন্স এবং নিবন্ধ।
...
3. আপনার সমাধান ফাইল `robot` মডিউলের পাশে সংরক্ষণ করুন। শুরু করার জন্য আর্কাইভ থেকে **`sample_solution.py`** ব্যবহার করুন।
4. ভিন্ন অনুশীলন চালাতে, **`task()`**-এ দেওয়া স্ট্রিং পরিবর্তন করুন (উপরে **`task()`-এর জন্য উপলব্ধ কাজ** অংশ দেখুন)।

প্রয়োজনীয়তা: স্ট্যান্ডার্ড লাইব্রেরিসহ **Python 3.7+** (UI `tkinter` ব্যবহার করে, যা ডেস্কটপ সিস্টেমের বেশিরভাগ Python ইনস্টলেশনে অন্তর্ভুক্ত থাকে)।
