...
- кнопки Выполнить, Шаг, выбор обстановки.
...
1. Ученик создает файл `.py` с вызовом `task("intro1")` (или другой задачи из каталога) и командами Робота.
