...
![Окно Робота: успешное завершение, все обстановки задания пройдены.](../../website/img/all_done/w45_ru.webp)
...
![Задача intro1.](../../website/img/tasks/intro1_env0.webp)
...
![Окно Робота с заданием intro8: закрасить отмеченные клетки.](../../website/img/tasks/intro8_env0.webp)
...
![Задача w2, первая обстановка: вертикальный коридор.](../../website/img/tasks/w2_env0.webp)
